...
// For the flags argument of CreateMonPicSprite
#define MON_PIC_AFFINE_BACK   0
#define MON_PIC_AFFINE_FRONT  1
#define MON_PIC_AFFINE_NONE   3
#define F_MON_PIC_NO_AFFINE (1 << 7)

#define MON_PIC_NO_AFFINE_BACK  MON_PIC_AFFINE_BACK  | F_MON_PIC_NO_AFFINE
#define MON_PIC_NO_AFFINE_FRONT MON_PIC_AFFINE_FRONT | F_MON_PIC_NO_AFFINE
