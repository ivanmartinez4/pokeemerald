...
static const struct SearchOptionText sDexSearchTypeOptions[NUMBER_OF_MON_TYPES + 2] = // + 2 for "None" and terminator
{
...
// Spinda use the personality of the first seen individual of that species
...
u16 CreateMonSpriteFromNationalDexNumber(u16 nationalNum, s16 x, s16 y, u16 paletteSlot)
{
    ...
    return CreateMonPicSprite(nationalNum, SHINY_ODDS, GetPokedexMonPersonality(nationalNum), MON_PIC_NO_AFFINE_FRONT, x, y, paletteSlot, TAG_NONE);
}

static u16 CreateSizeScreenTrainerPic(u16 species, s16 x, s16 y, s8 paletteSlot)
{
    return CreateTrainerPicSprite(species, x, y, paletteSlot, TAG_NONE);
}
