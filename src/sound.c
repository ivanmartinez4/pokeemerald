...
static const struct Fanfare sFanfares[] = {
    ...
    [FANFARE_BW_OBTAIN_KEY_ITEM]       = { MUS_BW_OBTAIN_KEY_ITEM        , 170 },
    [FANFARE_BW_LEVEL_UP]              = { MUS_BW_LEVEL_UP               ,  80 },
    [FANFARE_BW_HEAL]                  = { MUS_BW_HEAL                   , 160 },
    [FANFARE_BW_DEX_RATING_1]          = { MUS_BW_DEX_RATING_1           , 200 },
    [FANFARE_BW_DEX_RATING_2]          = { MUS_BW_DEX_RATING_2           , 180 },
    [FANFARE_BW_DEX_RATING_3]          = { MUS_BW_DEX_RATING_3           , 220 },
    [FANFARE_BW_DEX_RATING_4]          = { MUS_BW_DEX_RATING_4           , 210 },
    [FANFARE_BW_DEX_RATING_5]          = { MUS_BW_DEX_RATING_5           , 210 },
    [FANFARE_BW_DEX_RATING_6]          = { MUS_BW_DEX_RATING_6           , 370 },
    [FANFARE_BW_XTRANSCEIVER]          = { MUS_BW_XTRANSCEIVER_CALL      , 210 },
    [FANFARE_BW_OBTAIN_ITEM]           = { MUS_BW_OBTAIN_ITEM            , 160 },
    [FANFARE_BW_EVOLVED]               = { MUS_BW_EVOLVED                , 240 },
    [FANFARE_BW_OBTAIN_BADGE]          = { MUS_BW_OBTAIN_BADGE           , 340 },
    [FANFARE_BW_OBTAIN_TMHM]           = { MUS_BW_OBTAIN_TMHM            , 220 },
    [FANFARE_BW_MOVE_DELETED]          = { MUS_BW_MOVE_DELETED           , 180 },
    [FANFARE_BW_LIGHT_DARK_STONE]      = { MUS_BW_OBTAIN_LIGHT_DARK_STONE, 195 },
    [FANFARE_BW_RECEIVE_EGG]           = { MUS_BW_OBTAIN_EGG             , 155 },
    [FANFARE_BW_OBTAIN_B_POINTS]       = { MUS_BW_OBTAIN_B_POINTS        , 250 },
    [FANFARE_BW_ACCESSORY]             = { MUS_BW_OBTAIN_ACCESSORY       , 160 },
    [FANFARE_BW_FEELING_CHECK_START]   = { MUS_BW_FEELING_CHECK_START    , 162 },
    [FANFARE_BW_FEELING_CHECK_3]       = { MUS_BW_FEELING_CHECK_3        , 244 },
    [FANFARE_BW_FEELING_CHECK_2]       = { MUS_BW_FEELING_CHECK_2        , 200 },
    [FANFARE_BW_FEELING_CHECK_1]       = { MUS_BW_FEELING_CHECK_1        , 120 },
    [FANFARE_BW_MISSION_START]         = { MUS_BW_MISSION_START          , 280 },
    [FANFARE_BW_MISSION_CLEAR]         = { MUS_BW_MISSION_CLEAR          , 270 },
    [FANFARE_BW_MISSION_FAILED]        = { MUS_BW_MISSION_FAILED         , 180 },
    [FANFARE_BW_OBTAIN_BERRY]          = { MUS_BW_OBTAIN_BERRY           , 120 },
    [FANFARE_BW_QUIZ]                  = { MUS_BW_ME_QUIZ                ,  60 },
    [FANFARE_BW_DEL_POWER]             = { MUS_BW_ME_DEL_POWER           , 110 },
    [FANFARE_B2_POKESTAR_STUDIOS]      = { MUS_B2_POKESTAR_FANFARE       , 445 },
    [FANFARE_B2_JOIN_AVENUE_1]         = { MUS_B2_JOIN_AVENUE_RANK_UP_1  , 205 },
    [FANFARE_B2_JOIN_AVENUE_2]         = { MUS_B2_JOIN_AVENUE_RANK_UP_2  , 310 },
    [FANFARE_B2_JOIN_AVENUE_3]         = { MUS_B2_JOIN_AVENUE_RAFFLE     , 110 },
    [FANFARE_B2_EARN_MEDAL]            = { MUS_B2_PARTICIPATION_MEDAL    , 230 },
    [FANFARE_B2_MEDAL_BOX]             = { MUS_B2_MEDAL_BOX_UPGRADED     , 210 },
    [FANFARE_B2_START_MINIGAME]        = { MUS_B2_XTRANSCEIVER_GAME_START, 110 },
    [FANFARE_B2_WON_MINIGAME]          = { MUS_B2_XTRANSCEIVER_GAME_WIN  , 156 },
    [FANFARE_B2_TYMPOLE_CHOIR]         = { MUS_B2_TYMPOLE_CHOIR          , 307 },
    [FANFARE_B2_HABITAT_LIST_1]        = { MUS_B2_HABITAT_LIST_1         , 152 },
    [FANFARE_B2_HABITAT_LIST_2]        = { MUS_B2_HABITAT_LIST_2         , 152 },
    [FANFARE_B2_MEDAL_RALLY_COMPLETE]  = { MUS_B2_MEDAL_RALLY_COMPLETE   , 240 },
    [FANFARE_B2_XTRANSCEIVER_LONG]     = { MUS_B2_XTRANSCEIVER_CALL_LONG , 435 },
};
