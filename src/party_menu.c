...
static void PrintMessage(const u8 *text)
{
    ...
    AddTextPrinterParameterized2(WIN_MSG, FONT_NORMAL, text, GetPlayerTextSpeedDelay(), 0, TEXT_COLOR_02, TEXT_COLOR_01, TEXT_COLOR_03);
}
...
static void DisplayLevelUpStatsPg1(u8 taskId)
{
    ...
    DrawLevelUpWindowPg1(arrayPtr[12], arrayPtr, &arrayPtr[6], TEXT_COLOR_01, TEXT_COLOR_02, TEXT_COLOR_03);
...
static void DisplayLevelUpStatsPg2(u8 taskId)
{
    ...
    DrawLevelUpWindowPg2(arrayPtr[12], &arrayPtr[6], TEXT_COLOR_01, TEXT_COLOR_02, TEXT_COLOR_03);
    CopyWindowToVram(arrayPtr[12], COPYWIN_GFX);
    ScheduleBgCopyTilemapToVram(2);
}
