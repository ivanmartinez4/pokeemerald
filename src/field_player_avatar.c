...
static bool8 Fishing_MonOnHook(struct Task *task)
{
    ...
    AddTextPrinterParameterized2(0, FONT_NORMAL, gText_PokemonOnHook, 1, 0, TEXT_COLOR_02, TEXT_COLOR_01, TEXT_COLOR_03);
    task->tStep++;
    task->tFrameCounter = 0;
    return FALSE;
}
...
static bool8 Fishing_NotEvenNibble(struct Task *task)
{
    ...
    FillWindowPixelBuffer(0, PIXEL_FILL(1));
    AddTextPrinterParameterized2(0, FONT_NORMAL, gText_NotEvenANibble, 1, 0, TEXT_COLOR_02, TEXT_COLOR_01, TEXT_COLOR_03);
...
static bool8 Fishing_GotAway(struct Task *task)
{
    ...
    StartSpriteAnim(&gSprites[gPlayerAvatar.spriteId], GetFishingNoCatchDirectionAnimNum(GetPlayerFacingDirection()));
    FillWindowPixelBuffer(0, PIXEL_FILL(1));
    AddTextPrinterParameterized2(0, FONT_NORMAL, gText_ItGotAway, 1, 0, TEXT_COLOR_02, TEXT_COLOR_01, TEXT_COLOR_03);
    task->tStep++;
    return TRUE;
}
