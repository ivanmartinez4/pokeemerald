...
static const u8 sText_PkmnHurtByFreeze[] = _("¡{B_ATK_NAME_WITH_PREFIX} se resiente\nde su congelamiento!");
...
static const u8 sText_PkmnWasBurnHealed[] = _("¡{B_DEF_NAME_WITH_PREFIX} fue\ncurado de su quemadura!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNWASBURNHEALED - BATTLESTRINGS_TABLE_START] = sText_PkmnWasBurnHealed,
};
