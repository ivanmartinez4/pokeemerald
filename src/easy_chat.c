...
static void PrintTitle(void)
{
    ...
    PrintEasyChatTextWithColors(WIN_TITLE, FONT_NORMAL, titleText, xOffset, 1, TEXT_SKIP_DRAW, TEXT_COLOR_00, TEXT_COLOR_02, TEXT_COLOR_03);
        ...
        for (j = 0; j < 2; j++)
        {
            ...
            if (easyChatWord != EC_EMPTY_WORD)
            {
                ...
                if (!DummyWordCheck(easyChatWord))
                    ...
                    PrintEasyChatTextWithColors(WIN_INPUT_SELECT, FONT_NORMAL, sScreenControl->wordSelectPrintBuffer, (j * 13 + 3) * 8, y, TEXT_SKIP_DRAW, TEXT_COLOR_01, TEXT_COLOR_05, TEXT_COLOR_03);
            }
        }
