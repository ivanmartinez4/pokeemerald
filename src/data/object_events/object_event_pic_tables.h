...
static const struct SpriteFrameImage sPicTable_VenusaurF[] = {
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 0),
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 1),
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 2),
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 3),
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 4),
    overworld_frame(gObjectEventPic_VenusaurF, 4, 4, 5),
};
...
static const struct SpriteFrameImage sPicTable_AegislashBlade[] = {
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 0),
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 1),
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 2),
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 3),
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 4),
    overworld_frame(gObjectEventPic_AegislashBlade, 4, 4, 5),
};
