...
#define SOUND_LIST_BGM \
    ...
    X(MUS_BW_INTRO_1                  , "MUS-BW-INTRO-1"                  ) \
    X(MUS_BW_INTRO_2                  , "MUS-BW-INTRO-2"                  ) \
    X(MUS_BW_TITLE                    , "MUS-BW-TITLE"                    ) \
    X(MUS_BW_NEW_GAME_1               , "MUS-BW-NEW-GAME-1"               ) \
    X(MUS_BW_NEW_GAME_2               , "MUS-BW-NEW-GAME-2"               ) \
    X(MUS_BW_EVOLUTION_INTRO          , "MUS-BW-EVOLUTION-INTRO"          ) \
    X(MUS_BW_EVOLUTION                , "MUS-BW-EVOLUTION"                ) \
    X(MUS_BW_CYCLING                  , "MUS-BW-CYCLING"                  ) \
    X(MUS_BW_SURF                     , "MUS-BW-SURF"                     ) \
    X(MUS_BW_UNDERWATER               , "MUS-BW-UNDERWATER"               ) \
    X(MUS_BW_HALL_OF_FAME             , "MUS-BW-HALL-OF-FAME"             ) \
    X(MUS_BW_CREDITS                  , "MUS-BW-CREDITS"                  ) \
    X(MUS_BW_NUVEMA                   , "MUS-BW-NUVEMA"                   ) \
    X(MUS_BW_ACCUMULA                 , "MUS-BW-ACCUMULA"                 ) \
    X(MUS_BW_ANVILLE                  , "MUS-BW-ANVILLE"                  ) \
    X(MUS_BW_LACUNOSA                 , "MUS-BW-LACUNOSA"                 ) \
    X(MUS_BW_UNDELLA_WINTER           , "MUS-BW-UNDELLA-WINTER"           ) \
    X(MUS_BW_UNDELLA_SUMMER           , "MUS-BW-UNDELLA-SUMMER"           ) \
    X(MUS_BW_STRIATON                 , "MUS-BW-STRIATON"                 ) \
    X(MUS_BW_NACRENE                  , "MUS-BW-NACRENE"                  ) \
    X(MUS_BW_CASTELIA                 , "MUS-BW-CASTELIA"                 ) \
    X(MUS_BW_NIMBASA                  , "MUS-BW-NIMBASA"                  ) \
    X(MUS_BW_DRIFTVEIL                , "MUS-BW-DRIFTVEIL"                ) \
    X(MUS_BW_MISTRALTON               , "MUS-BW-MISTRALTON"               ) \
    X(MUS_BW_ICIRRUS                  , "MUS-BW-ICIRRUS"                  ) \
    X(MUS_BW_OPELUCID_BLACK           , "MUS-BW-OPELUCID-BLACK"           ) \
    X(MUS_BW_OPELUCID_WHITE           , "MUS-BW-OPELUCID-WHITE"           ) \
    X(MUS_BW_BLACK_CITY               , "MUS-BW-BLACK-CITY"               ) \
    X(MUS_BW_WHITE_FOREST             , "MUS-BW-WHITE-FOREST"             ) \
    X(MUS_BW_ROUTE1                   , "MUS-BW-ROUTE1"                   ) \
    X(MUS_BW_ROUTE2_SPRING            , "MUS-BW-ROUTE2-SPRING"            ) \
    X(MUS_BW_ROUTE2_SUMMER            , "MUS-BW-ROUTE2-SUMMER"            ) \
    X(MUS_BW_ROUTE2_AUTUMN            , "MUS-BW-ROUTE2-AUTUMN"            ) \
    X(MUS_BW_ROUTE2_WINTER            , "MUS-BW-ROUTE2-WINTER"            ) \
    X(MUS_BW_ROUTE4_SPRING            , "MUS-BW-ROUTE4-SPRING"            ) \
    X(MUS_BW_ROUTE4_SUMMER            , "MUS-BW-ROUTE4-SUMMER"            ) \
    X(MUS_BW_ROUTE4_AUTUMN            , "MUS-BW-ROUTE4-AUTUMN"            ) \
    X(MUS_BW_ROUTE4_WINTER            , "MUS-BW-ROUTE4-WINTER"            ) \
    X(MUS_BW_ROUTE6_SPRING            , "MUS-BW-ROUTE6-SPRING"            ) \
    X(MUS_BW_ROUTE6_SUMMER            , "MUS-BW-ROUTE6-SUMMER"            ) \
    X(MUS_BW_ROUTE6_AUTUMN            , "MUS-BW-ROUTE6-AUTUMN"            ) \
    X(MUS_BW_ROUTE6_WINTER            , "MUS-BW-ROUTE6-WINTER"            ) \
    X(MUS_BW_ROUTE12_SPRING           , "MUS-BW-ROUTE12-SPRING"           ) \
    X(MUS_BW_ROUTE12_SUMMER           , "MUS-BW-ROUTE12-SUMMER"           ) \
    X(MUS_BW_ROUTE12_AUTUMN           , "MUS-BW-ROUTE12-AUTUMN"           ) \
    X(MUS_BW_ROUTE12_WINTER           , "MUS-BW-ROUTE12-WINTER"           ) \
    X(MUS_BW_ROUTE10                  , "MUS-BW-ROUTE10"                  ) \
    X(MUS_BW_SKYARROW_BRIDGE          , "MUS-BW-SKYARROW-BRIDGE"          ) \
    X(MUS_BW_DRIFTVEIL_DRAWBRIDGE     , "MUS-BW-DRIFTVEIL-DRAWBRIDGE"     ) \
    X(MUS_BW_TUBELINE_BRIDGE          , "MUS-BW-TUBELINE-BRIDGE"          ) \
    X(MUS_BW_VILLAGE_BRIDGE           , "MUS-BW-VILLAGE-BRIDGE"           ) \
    X(MUS_BW_MARVELOUS_BRIDGE         , "MUS-BW-MARVELOUS-BRIDGE"         ) \
    X(MUS_BW_POKE_CENTER              , "MUS-BW-POKE-CENTER"              ) \
    X(MUS_BW_SHOPPING_MALL_NINE       , "MUS-BW-SHOPPING-MALL-NINE"       ) \
    X(MUS_BW_GYM                      , "MUS-BW-GYM"                      ) \
    X(MUS_BW_JUNIPER_LAB              , "MUS-BW-JUNIPER-LAB"              ) \
    X(MUS_BW_GATE                     , "MUS-BW-GATE"                     ) \
    X(MUS_BW_GEAR_STATION             , "MUS-BW-GEAR-STATION"             ) \
    X(MUS_BW_BATTLE_SUBWAY            , "MUS-BW-BATTLE-SUBWAY"            ) \
    X(MUS_BW_POKE_TRANSFER_LAB        , "MUS-BW-POKE-TRANSFER-LAB"        ) \
    X(MUS_BW_ROYAL_UNOVA              , "MUS-BW-ROYAL-UNOVA"              ) \
    X(MUS_BW_ENTRALINK                , "MUS-BW-ENTRALINK"                ) \
    X(MUS_BW_SOMEONES_ENTRALINK       , "MUS-BW-SOMEONES-ENTRALINK"       ) \
    X(MUS_BW_UNITY_TOWER              , "MUS-BW-UNITY-TOWER"              ) \
    ...
    X(MUS_BW_DREAMYARD                , "MUS-BW-DREAMYARD"                ) \
    X(MUS_BW_CHARGESTONE_CAVE         , "MUS-BW-CHARGESTONE-CAVE"         ) \
    X(MUS_BW_COLD_STORAGE             , "MUS-BW-COLD-STORAGE"             ) \
    X(MUS_BW_RELIC_CASTLE             , "MUS-BW-RELIC-CASTLE"             ) \
    X(MUS_BW_DRAGONSPIRAL_TOWER       , "MUS-BW-DRAGONSPIRAL-TOWER"       ) \
    X(MUS_BW_LOSTLORN_FOREST          , "MUS-BW-LOSTLORN-FOREST"          ) \
    X(MUS_BW_DRAGONSPIRAL_TOWER_TOP   , "MUS-BW-DRAGONSPIRAL-TOWER-TOP"   ) \
    X(MUS_BW_VICTORY_ROAD             , "MUS-BW-VICTORY-ROAD"             ) \
    X(MUS_BW_FOLLOW_ME_1              , "MUS-BW-FOLLOW-ME-1"              ) \
    X(MUS_BW_FOLLOW_ME_2              , "MUS-BW-FOLLOW-ME-2"              ) \
    X(MUS_BW_CHEREN                   , "MUS-BW-CHEREN"                   ) \
    X(MUS_BW_BIANCA                   , "MUS-BW-BIANCA"                   ) \
    X(MUS_BW_JUNIPER                  , "MUS-BW-JUNIPER"                  ) \
    X(MUS_BW_CEDRIC_JUNIPER           , "MUS-BW-CEDRIC-JUNIPER"           ) \
    X(MUS_BW_PLASMA                   , "MUS-BW-PLASMA"                   ) \
    X(MUS_BW_N                        , "MUS-BW-N"                        ) \
    X(MUS_BW_PLASMA_PLOTS             , "MUS-BW-PLASMA-PLOTS"             ) \
    X(MUS_BW_GHETSIS                  , "MUS-BW-GHETSIS"                  ) \
    X(MUS_BW_RELIC_SONG               , "MUS-BW-RELIC-SONG"               ) \
    X(MUS_BW_EMOTION                  , "MUS-BW-EMOTION"                  ) \
    X(MUS_BW_TROUBLE                  , "MUS-BW-TROUBLE"                  ) \
    X(MUS_BW_FAREWELL                 , "MUS-BW-FAREWELL"                 ) \
    X(MUS_BW_LOOKER                   , "MUS-BW-LOOKER"                   ) \
    X(MUS_BW_ALDER                    , "MUS-BW-ALDER"                    ) \
    X(MUS_BW_OPENING                  , "MUS-BW-OPENING"                  ) \
    X(MUS_BW_FERRIS_WHEEL             , "MUS-BW-FERRIS-WHEEL"             ) \
    X(MUS_BW_N_CASTLE_APPEARS         , "MUS-BW-N-CASTLE-APPEARS"         ) \
    X(MUS_BW_LEGEND_AWAKENS           , "MUS-BW-LEGEND-AWAKENS"           ) \
    X(MUS_BW_MUSICAL_THEATER          , "MUS-BW-MUSICAL-THEATER"          ) \
    X(MUS_BW_MUSICAL_DRESS_UP         , "MUS-BW-MUSICAL-DRESS-UP"         ) \
    X(MUS_BW_MUSICAL_BEFORE           , "MUS-BW-MUSICAL-BEFORE"           ) \
    X(MUS_BW_MUSICAL_1                , "MUS-BW-MUSICAL-1"                ) \
    X(MUS_BW_MUSICAL_2                , "MUS-BW-MUSICAL-2"                ) \
    X(MUS_BW_MUSICAL_3                , "MUS-BW-MUSICAL-3"                ) \
    X(MUS_BW_MUSICAL_4                , "MUS-BW-MUSICAL-4"                ) \
    X(MUS_BW_ENCOUNTER_BOY            , "MUS-BW-ENCOUNTER-BOY"            ) \
    X(MUS_BW_ENCOUNTER_GIRL           , "MUS-BW-ENCOUNTER-GIRL"           ) \
    X(MUS_BW_ENCOUNTER_TWINS          , "MUS-BW-ENCOUNTER-TWINS"          ) \
    X(MUS_BW_ENCOUNTER_ACE_TRAINER    , "MUS-BW-ENCOUNTER-ACE-TRAINER"    ) \
    X(MUS_BW_ENCOUNTER_ROUGHNECK      , "MUS-BW-ENCOUNTER-ROUGHNECK"      ) \
    X(MUS_BW_ENCOUNTER_LADY           , "MUS-BW-ENCOUNTER-LADY"           ) \
    X(MUS_BW_ENCOUNTER_CYCLIST        , "MUS-BW-ENCOUNTER-CYCLIST"        ) \
    X(MUS_BW_ENCOUNTER_PSYCHIC        , "MUS-BW-ENCOUNTER-PSYCHIC"        ) \
    X(MUS_BW_ENCOUNTER_SUSPICIOUS     , "MUS-BW-ENCOUNTER-SUSPICIOUS"     ) \
    X(MUS_BW_ENCOUNTER_POKEFAN        , "MUS-BW-ENCOUNTER-POKEFAN"        ) \
    X(MUS_BW_ENCOUNTER_HIKER          , "MUS-BW-ENCOUNTER-HIKER"          ) \
    X(MUS_BW_ENCOUNTER_CLERK          , "MUS-BW-ENCOUNTER-CLERK"          ) \
    X(MUS_BW_ENCOUNTER_RICH           , "MUS-BW-ENCOUNTER-RICH"           ) \
    X(MUS_BW_ENCOUNTER_PLASMA         , "MUS-BW-ENCOUNTER-PLASMA"         ) \
    X(MUS_BW_VS_WILD                  , "MUS-BW-VS-WILD"                  ) \
    X(MUS_BW_VS_WILD_STRONG           , "MUS-BW-VS-WILD-STRONG"           ) \
    X(MUS_BW_VS_TRAINER               , "MUS-BW-VS-TRAINER"               ) \
    X(MUS_BW_VS_SUBWAY_TRAINER        , "MUS-BW-VS-SUBWAY-TRAINER"        ) \
    X(MUS_BW_VS_GYM_LEADER            , "MUS-BW-VS-GYM-LEADER"            ) \
    ...
    X(MUS_BW_VS_N_FINAL               , "MUS-BW-VS-N-FINAL"               ) \
    X(MUS_BW_VS_GHETSIS               , "MUS-BW-VS-GHETSIS"               ) \
    X(MUS_BW_VS_RESHIRAM_ZEKROM       , "MUS-BW-VS-RESHIRAM-ZEKROM"       ) \
    X(MUS_BW_VS_KYUREM                , "MUS-BW-VS-KYUREM"                ) \
    X(MUS_BW_VS_LEGEND                , "MUS-BW-VS-LEGEND"                ) \
    X(MUS_BW_VS_CYNTHIA               , "MUS-BW-VS-CYNTHIA"               ) \
    X(MUS_BW_LOW_HEALTH               , "MUS-BW-LOW-HEALTH"               ) \
    X(MUS_BW_GYM_LEADER_LAST_MON      , "MUS-BW-GYM-LEADER-LAST-MON"      ) \
    ...
    X(MUS_BW_GLOBAL_TERMINAL          , "MUS-BW-GLOBAL-TERMINAL"          ) \
    X(MUS_BW_SPIN_TRADE               , "MUS-BW-SPIN-TRADE"               ) \
    X(MUS_BW_GTS                      , "MUS-BW-GTS"                      ) \
    X(MUS_BW_WIFI_BATTLE_LOBBY        , "MUS-BW-WIFI-BATTLE-LOBBY"        ) \
    X(MUS_BW_ENCOUNTER_CYNTHIA        , "MUS-BW-ENCOUNTER-CYNTHIA"        ) \
    X(MUS_BW_CHEREN_BIANCA            , "MUS-BW-CHEREN-BIANCA"            ) \
    X(MUS_BW_ROCKET                   , "MUS-BW-ROCKET"                   ) \
    ...
    X(MUS_BW_MUSICAL_DLC_4            , "MUS-BW-MUSICAL-DLC-4"            ) \
    X(MUS_BW_MUSICAL_DLC_5            , "MUS-BW-MUSICAL-DLC-5"            ) \
    X(MUS_BW_HEAL                     , "MUS-BW-HEAL"                     ) \
    X(MUS_BW_LEVEL_UP                 , "MUS-BW-LEVEL-UP"                 ) \
    X(MUS_BW_OBTAIN_ITEM              , "MUS-BW-OBTAIN-ITEM"              ) \
    X(MUS_BW_OBTAIN_KEY_ITEM          , "MUS-BW-OBTAIN-KEY-ITEM"          ) \
    X(MUS_BW_EVOLVED                  , "MUS-BW-EVOLVED"                  ) \
    X(MUS_BW_OBTAIN_BADGE             , "MUS-BW-OBTAIN-BADGE"             ) \
    X(MUS_BW_OBTAIN_TMHM              , "MUS-BW-OBTAIN-TMHM"              ) \
    X(MUS_BW_OBTAIN_ACCESSORY         , "MUS-BW-OBTAIN-ACCESSORY"         ) \
    X(MUS_BW_MOVE_DELETED             , "MUS-BW-MOVE-DELETED"             ) \
    X(MUS_BW_OBTAIN_BERRY             , "MUS-BW-OBTAIN-BERRY"             ) \
    X(MUS_BW_DEX_RATING_1             , "MUS-BW-DEX-RATING-1"             ) \
    X(MUS_BW_DEX_RATING_2             , "MUS-BW-DEX-RATING-2"             ) \
    X(MUS_BW_DEX_RATING_3             , "MUS-BW-DEX-RATING-3"             ) \
    X(MUS_BW_DEX_RATING_4             , "MUS-BW-DEX-RATING-4"             ) \
    X(MUS_BW_DEX_RATING_5             , "MUS-BW-DEX-RATING-5"             ) \
    X(MUS_BW_DEX_RATING_6             , "MUS-BW-DEX-RATING-6"             ) \
    X(MUS_BW_OBTAIN_EGG               , "MUS-BW-OBTAIN-EGG"               ) \
    X(MUS_BW_OBTAIN_B_POINTS          , "MUS-BW-OBTAIN-B-POINTS"          ) \
    X(MUS_BW_FEELING_CHECK_3          , "MUS-BW-FEELING-CHECK-3"          ) \
    X(MUS_BW_FEELING_CHECK_2          , "MUS-BW-FEELING-CHECK-2"          ) \
    X(MUS_BW_FEELING_CHECK_1          , "MUS-BW-FEELING-CHECK-1"          ) \
    X(MUS_BW_FEELING_CHECK_START      , "MUS-BW-FEELING-CHECK-START"      ) \
    X(MUS_BW_MISSION_START            , "MUS-BW-MISSION-START"            ) \
    X(MUS_BW_MISSION_CLEAR            , "MUS-BW-MISSION-CLEAR"            ) \
    X(MUS_BW_MISSION_FAILED           , "MUS-BW-MISSION-FAILED"           ) \
    X(MUS_BW_OBTAIN_LIGHT_DARK_STONE  , "MUS-BW-OBTAIN-LIGHT-DARK-STONE"  ) \
    X(MUS_BW_XTRANSCEIVER_CALL        , "MUS-BW-XTRANSCEIVER-CALL"        ) \
    X(MUS_BW_ME_QUIZ                  , "MUS-BW-ME-QUIZ"                  ) \
    X(MUS_BW_ME_DEL_POWER             , "MUS-BW-ME-DEL-POWER"             ) \
    X(MUS_BW_POKE_TRANSFER_BOX        , "MUS-BW-POKE-TRANSFER-BOX"        ) \
    X(MUS_BW_POKE_TRANSFER_GAME       , "MUS-BW-POKE-TRANSFER-GAME"       ) \
    X(MUS_B2_INTRO                    , "MUS-B2-INTRO"                    ) \
    X(MUS_B2_CREDITS                  , "MUS-B2-CREDITS"                  ) \
    X(MUS_B2_DRIFTVEIL_GYM            , "MUS-B2-DRIFTVEIL-GYM"            ) \
    X(MUS_B2_N_CASTLE                 , "MUS-B2-N-CASTLE"                 ) \
    X(MUS_B2_BLACK_TOWER_LOBBY        , "MUS-B2-BLACK-TOWER-LOBBY"        ) \
    X(MUS_B2_WHITE_TREEHOLLOW_LOBBY   , "MUS-B2-WHITE-TREEHOLLOW-LOBBY"   ) \
    X(MUS_B2_BLACK_TOWER              , "MUS-B2-BLACK-TOWER"              ) \
    X(MUS_B2_WHITE_TREEHOLLOW         , "MUS-B2-WHITE-TREEHOLLOW"         ) \
    X(MUS_B2_CHEREN                   , "MUS-B2-CHEREN"                   ) \
    X(MUS_B2_BIANCA                   , "MUS-B2-BIANCA"                   ) \
    X(MUS_B2_N                        , "MUS-B2-N"                        ) \
    X(MUS_B2_NIMBASA_GYM_1            , "MUS-B2-NIMBASA-GYM-1"            ) \
    X(MUS_B2_NIMBASA_GYM_2            , "MUS-B2-NIMBASA-GYM-2"            ) \
    X(MUS_B2_CASTELIA_GYM             , "MUS-B2-CASTELIA-GYM"             ) \
    X(MUS_B2_VIRBANK_GYM              , "MUS-B2-VIRBANK-GYM"              ) \
    X(MUS_B2_OPENING                  , "MUS-B2-OPENING"                  ) \
    X(MUS_B2_ASPERTIA                 , "MUS-B2-ASPERTIA"                 ) \
    X(MUS_B2_VIRBANK                  , "MUS-B2-VIRBANK"                  ) \
    X(MUS_B2_HUMILAU                  , "MUS-B2-HUMILAU"                  ) \
    X(MUS_B2_ENCOUNTER_NEO_PLASMA     , "MUS-B2-ENCOUNTER-NEO-PLASMA"     ) \
    X(MUS_B2_VS_WILD                  , "MUS-B2-VS-WILD"                  ) \
    X(MUS_B2_VS_TRAINER               , "MUS-B2-VS-TRAINER"               ) \
    X(MUS_B2_VS_GYM_LEADER            , "MUS-B2-VS-GYM-LEADER"            ) \
    X(MUS_B2_VS_SINNOH_LEGEND         , "MUS-B2-VS-SINNOH-LEGEND"         ) \
    X(MUS_B2_VS_N                     , "MUS-B2-VS-N"                     ) \
    X(MUS_B2_VS_UXIE_MESPRIT_AZELF    , "MUS-B2-VS-UXIE-MESPRIT-AZELF"    ) \
    X(MUS_B2_VS_REGI                  , "MUS-B2-VS-REGI"                  ) \
    X(MUS_B2_GYM_LEADER_LAST_MON      , "MUS-B2-GYM-LEADER-LAST-MON"      ) \
    X(MUS_B2_N_ROOM                   , "MUS-B2-N-ROOM"                   ) \
    X(MUS_B2_ROUTE19_SPRING           , "MUS-B2-ROUTE19-SPRING"           ) \
    X(MUS_B2_ROUTE19_SUMMER           , "MUS-B2-ROUTE19-SUMMER"           ) \
    X(MUS_B2_ROUTE19_AUTUMN           , "MUS-B2-ROUTE19-AUTUMN"           ) \
    X(MUS_B2_ROUTE19_WINTER           , "MUS-B2-ROUTE19-WINTER"           ) \
    X(MUS_B2_ROUTE22_SPRING           , "MUS-B2-ROUTE22-SPRING"           ) \
    X(MUS_B2_ROUTE22_SUMMER           , "MUS-B2-ROUTE22-SUMMER"           ) \
    X(MUS_B2_ROUTE22_AUTUMN           , "MUS-B2-ROUTE22-AUTUMN"           ) \
    X(MUS_B2_ROUTE22_WINTER           , "MUS-B2-ROUTE22-WINTER"           ) \
    X(MUS_B2_ROUTE23                  , "MUS-B2-ROUTE23"                  ) \
    X(MUS_B2_ROAD_TO_REVERSAL_MOUNTAIN, "MUS-B2-ROAD-TO-REVERSAL-MOUNTAIN") \
    X(MUS_B2_FLOCCESY                 , "MUS-B2-FLOCCESY"                 ) \
    X(MUS_B2_LENTIMAS                 , "MUS-B2-LENTIMAS"                 ) \
    X(MUS_B2_FLOCCESY_RANCH           , "MUS-B2-FLOCCESY-RANCH"           ) \
    X(MUS_B2_CASTELIA_SEWERS          , "MUS-B2-CASTELIA-SEWERS"          ) \
    X(MUS_B2_REVERSAL_MOUNTAIN_WHITE  , "MUS-B2-REVERSAL-MOUNTAIN-WHITE"  ) \
    X(MUS_B2_REVERSAL_MOUNTAIN_BLACK  , "MUS-B2-REVERSAL-MOUNTAIN-BLACK"  ) \
    X(MUS_B2_STRANGE_HOUSE            , "MUS-B2-STRANGE-HOUSE"            ) \
    X(MUS_B2_PLASMA_FRIGATE_1         , "MUS-B2-PLASMA-FRIGATE-1"         ) \
    X(MUS_B2_PLASMA_FRIGATE_2         , "MUS-B2-PLASMA-FRIGATE-2"         ) \
    X(MUS_B2_PLASMA_FRIGATE_3         , "MUS-B2-PLASMA-FRIGATE-3"         ) \
    X(MUS_B2_SEALED_CHAMBER           , "MUS-B2-SEALED-CHAMBER"           ) \
    X(MUS_B2_CAVE_OF_BEING            , "MUS-B2-CAVE-OF-BEING"            ) \
    X(MUS_B2_MARINE_TUBE              , "MUS-B2-MARINE-TUBE"              ) \
    X(MUS_B2_PWT_LOBBY                , "MUS-B2-PWT-LOBBY"                ) \
    X(MUS_B2_PWT                      , "MUS-B2-PWT"                      ) \
    X(MUS_B2_PWT_WINNER               , "MUS-B2-PWT-WINNER"               ) \
    X(MUS_B2_POKESTAR_STUDIOS         , "MUS-B2-POKESTAR-STUDIOS"         ) \
    X(MUS_B2_POKESTAR_STUDIOS_FILMING , "MUS-B2-POKESTAR-STUDIOS-FILMING" ) \
    X(MUS_B2_POKESTAR_STUDIOS_BATTLE  , "MUS-B2-POKESTAR-STUDIOS-BATTLE"  ) \
    X(MUS_B2_POKESTAR_STUDIOS_GLORY   , "MUS-B2-POKESTAR-STUDIOS-GLORY"   ) \
    X(MUS_B2_POKESTAR_STUDIOS_DEFEAT  , "MUS-B2-POKESTAR-STUDIOS-DEFEAT"  ) \
    X(MUS_B2_POKESTAR_STUDIOS_INVASION, "MUS-B2-POKESTAR-STUDIOS-INVASION") \
    X(MUS_B2_POKESTAR_STUDIOS_SUCCESS , "MUS-B2-POKESTAR-STUDIOS-SUCCESS" ) \
    X(MUS_B2_POKESTAR_STUDIOS_RETREAT , "MUS-B2-POKESTAR-STUDIOS-RETREAT" ) \
    X(MUS_B2_POKESTAR_STUDIOS_WEIRD   , "MUS-B2-POKESTAR-STUDIOS-WEIRD"   ) \
    X(MUS_B2_POKESTAR_STUDIOS_LOVE    , "MUS-B2-POKESTAR-STUDIOS-LOVE"    ) \
    X(MUS_B2_POKESTAR_STUDIOS_SORROW  , "MUS-B2-POKESTAR-STUDIOS-SORROW"  ) \
    X(MUS_B2_POKESTAR_STUDIOS_HORROR  , "MUS-B2-POKESTAR-STUDIOS-HORROR"  ) \
    X(MUS_B2_POKESTAR_STUDIOS_PURIFIED, "MUS-B2-POKESTAR-STUDIOS-PURIFIED") \
    X(MUS_B2_POKESTAR_STUDIOS_FEAR    , "MUS-B2-POKESTAR-STUDIOS-FEAR"    ) \
    X(MUS_B2_POKESTAR_STUDIOS_HUMOR   , "MUS-B2-POKESTAR-STUDIOS-HUMOR"   ) \
    X(MUS_B2_POKESTAR_STUDIOS_DESPAIR , "MUS-B2-POKESTAR-STUDIOS-DESPAIR" ) \
    X(MUS_B2_POKESTAR_STUDIOS_SHOCK   , "MUS-B2-POKESTAR-STUDIOS-SHOCK"   ) \
    X(MUS_B2_MISTRALTON_GYM           , "MUS-B2-MISTRALTON-GYM"           ) \
    X(MUS_B2_HUMILAU_GYM              , "MUS-B2-HUMILAU-GYM"              ) \
    X(MUS_B2_OPELUCID_GYM             , "MUS-B2-OPELUCID-GYM"             ) \
    X(MUS_B2_XTRANSCEIVER_MINIGAMES   , "MUS-B2-XTRANSCEIVER-MINIGAMES"   ) \
    X(MUS_B2_UNOVA_LINK               , "MUS-B2-UNOVA-LINK"               ) \
    X(MUS_B2_JOIN_AVENUE              , "MUS-B2-JOIN-AVENUE"              ) \
    X(MUS_B2_FUNFEST_MISSION          , "MUS-B2-FUNFEST-MISSION"          ) \
    X(MUS_B2_KYUREM_SCENE_1           , "MUS-B2-KYUREM-SCENE-1"           ) \
    X(MUS_B2_KYUREM_SCENE_2           , "MUS-B2-KYUREM-SCENE-2"           ) \
    X(MUS_B2_KYUREM_SCENE_3           , "MUS-B2-KYUREM-SCENE-3"           ) \
    X(MUS_B2_KYUREM_SCENE_4           , "MUS-B2-KYUREM-SCENE-4"           ) \
    X(MUS_B2_OPELUCID_ATTACKED        , "MUS-B2-OPELUCID-ATTACKED"        ) \
    X(MUS_B2_PLASMA_FRIGATE_SCENE     , "MUS-B2-PLASMA-FRIGATE-SCENE"     ) \
    X(MUS_B2_RIVAL                    , "MUS-B2-RIVAL"                    ) \
    X(MUS_B2_COLRESS                  , "MUS-B2-COLRESS"                  ) \
    X(MUS_B2_SHADOW_TRIAD             , "MUS-B2-SHADOW-TRIAD"             ) \
    X(MUS_B2_ZINZOLIN                 , "MUS-B2-ZINZOLIN"                 ) \
    X(MUS_B2_OPELUCID_FROZEN          , "MUS-B2-OPELUCID-FROZEN"          ) \
    X(MUS_B2_ENCOUNTER_BEAUTY         , "MUS-B2-ENCOUNTER-BEAUTY"         ) \
    X(MUS_B2_ENCOUNTER_CLOWN          , "MUS-B2-ENCOUNTER-CLOWN"          ) \
    X(MUS_B2_VS_LEADER_KANTO          , "MUS-B2-VS-LEADER-KANTO"          ) \
    X(MUS_B2_VS_CHAMPION_KANTO        , "MUS-B2-VS-CHAMPION-KANTO"        ) \
    X(MUS_B2_VS_LEADER_JOHTO          , "MUS-B2-VS-LEADER-JOHTO"          ) \
    X(MUS_B2_VS_CHAMPION_JOHTO        , "MUS-B2-VS-CHAMPION-JOHTO"        ) \
    X(MUS_B2_VS_LEADER_HOENN          , "MUS-B2-VS-LEADER-HOENN"          ) \
    X(MUS_B2_VS_CHAMPION_HOENN        , "MUS-B2-VS-CHAMPION-HOENN"        ) \
    X(MUS_B2_VS_LEADER_SINNOH         , "MUS-B2-VS-LEADER-SINNOH"         ) \
    ...
    X(MUS_B2_VS_RIVAL                 , "MUS-B2-VS-RIVAL"                 ) \
    X(MUS_B2_VICTORY_PWT              , "MUS-B2-VICTORY-PWT"              ) \
    X(MUS_B2_HIDDEN_GROTTO            , "MUS-B2-HIDDEN-GROTTO"            ) \
    X(MUS_B2_JOIN_AVENUE_GREETING     , "MUS-B2-JOIN-AVENUE-GREETING"     ) \
    X(MUS_B2_NEO_PLASMA               , "MUS-B2-NEO-PLASMA"               ) \
    X(MUS_B2_END                      , "MUS-B2-END"                      ) \
    X(MUS_B2_XTRANSCEIVER_GAME_START  , "MUS-B2-XTRANSCEIVER-GAME-START"  ) \
    X(MUS_B2_XTRANSCEIVER_GAME_WIN    , "MUS-B2-XTRANSCEIVER-GAME-WIN"    ) \
    X(MUS_B2_XTRANSCEIVER_03          , "MUS-B2-XTRANSCEIVER-03"          ) \
    X(MUS_B2_XTRANSCEIVER_04          , "MUS-B2-XTRANSCEIVER-04"          ) \
    X(MUS_B2_MEDAL_BOX_UPGRADED       , "MUS-B2-MEDAL-BOX-UPGRADED"       ) \
    X(MUS_B2_PARTICIPATION_MEDAL      , "MUS-B2-PARTICIPATION-MEDAL"      ) \
    X(MUS_B2_MEDAL_RALLY_COMPLETE     , "MUS-B2-MEDAL-RALLY-COMPLETE"     ) \
    X(MUS_B2_TYMPOLE_CHOIR            , "MUS-B2-TYMPOLE-CHOIR"            ) \
    X(MUS_B2_JOIN_AVENUE_RANK_UP_1    , "MUS-B2-JOIN-AVENUE-RANK-UP-1"    ) \
    X(MUS_B2_JOIN_AVENUE_RANK_UP_2    , "MUS-B2-JOIN-AVENUE-RANK-UP-2"    ) \
    X(MUS_B2_JOIN_AVENUE_RAFFLE       , "MUS-B2-JOIN-AVENUE-RAFFLE"       ) \
    X(MUS_B2_XTRANSCEIVER_CALL_LONG   , "MUS-B2-XTRANSCEIVER-CALL-LONG"   ) \
    X(MUS_B2_HABITAT_LIST_1           , "MUS-B2-HABITAT-LIST-1"           ) \
    X(MUS_B2_HABITAT_LIST_2           , "MUS-B2-HABITAT-LIST-2"           ) \
    X(MUS_B2_POKESTAR_FANFARE         , "MUS-B2-POKESTAR-FANFARE"         ) \
